      ...
      <View style={styles.body}>
        ...
        <LineChart
          data={{
            ...
            datasets: [
              {
                data: [20, 22, 25, 24, 23, 22], // Datos de ejemplo, reemplazar con datos reales
              },
            ],
          }}
          width={300}
        ...
        <Text style={styles.sectionTitle}>Gráfico de Humedad</Text>
        <LineChart
          data={{
            labels: ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio'],
            datasets: [
              {
                data: [60, 65, 68, 70, 72, 75], // Datos de ejemplo, reemplazar con datos reales
              },
            ],
          }}
          width={300}
